...
exports.handleSpool = exports.handleUniones = exports.handleReporte = exports.handleVincular = exports.handleMessage = void 0;
...
const handleSpool = async (ctx) => {
    try {
        ...
        const spools = await (0, appsheet_js_1.getSpoolStatus)(query);
        if (spools.length === 0) {
...
exports.handleSpool = handleSpool;
